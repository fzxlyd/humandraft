...
- Seeded HumanDraft as an open-source writing critique engine.
- Added deterministic audit CLI.
- Added built-in anti-slop rules.
- Added `qiba`, `story`, and `research` profiles.
